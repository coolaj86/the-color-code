...
var questionnaire = require(process.argv[2] ||
  path.join(__dirname, "./questionnaire.json"));
var questionsRaw = questionnaire.questions || questionnaire;
var title = questionnaire.title || "The Color Code";
var defaultQuestion =
  questionnaire.defaultQuestion || "Which described you best as a child?";
var categories = questionnaire.categories || ["red", "blue", "white", "yellow"];
var finishedMsg = "Now go read the book to learn more!";
var total = questionsRaw.length;
var questions = [];
var doneQuestions = [];
var current;
var responses = {
...
var categoriesDeck = categories.join(",").split(",");

categories.forEach(function (cat) {
  responses.totals[cat] = 0;
});

// TODO knuth-fisher-yates
function shuffle() {
...
function interpretAnswer(chunk) {
  ...
  if (color) {
    ...
    console.log(
      "Sorry, I didn't understand you. Respond again with a number such as 1, 2, 3, or 4"
    );
    return;
  }
  console.log("");
...
console.log("");
console.log(
  "Type 'b' to go back to the previous question if you make a boo-boo."
);
console.log("");
presentQuestion();
